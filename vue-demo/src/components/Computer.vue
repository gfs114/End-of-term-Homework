    ...
    <transition name="computer-detail">
      <div v-if="selectedComputer" class="detail-overlay" :style="detailVars" @click.self="closeComputerDetail">
        <section class="detail-panel" aria-label="电脑详情">
          ...
          <div class="computer-visual detail-visual" :style="{ '--accent-color': selectedComputer.accent }">
            <div class="screen"></div>
            <div class="base"></div>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      brands: [
        { name: "Apple", shortName: "", color: "linear-gradient(135deg, #111827, #6b7280)" },
        ...
        { name: "机械革命", shortName: "MECH", color: "linear-gradient(135deg, #7c3aed, #2563eb)" },
